...
class MyPortalWidget extends StatefulWidget {
  const MyPortalWidget({Key key}) : super(key: key);

  @override
  _MyPortalWidgetState createState() => _MyPortalWidgetState();
}

class _MyPortalWidgetState extends State<MyPortalWidget> {
